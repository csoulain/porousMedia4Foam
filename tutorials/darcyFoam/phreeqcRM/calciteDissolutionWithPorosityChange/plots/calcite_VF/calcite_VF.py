...
plt.plot(DistMIN, Calc10MIN,'r',marker="*",linewidth=3,markersize=9)
...
plt.plot(DistMIN, Calc100MIN,'r',marker="x",linewidth=3,markersize=9)
...
plt.plot(DistMIN, Calc120MIN,'r',marker="v",linewidth=3,markersize=9)
...
plt.plot(Dist, Calc10,'c',marker="*",linewidth=3,markersize=9)
...
plt.plot(Dist, Calc100,'c',marker="x",linewidth=3,markersize=9)
...
plt.plot(Dist, Calc120,'c',marker="v",linewidth=3,markersize=9)
...
plt.plot(DistDBS, Calc10DBS,'k',marker="*",linewidth=3,markersize=9)
...
plt.plot(DistDBS, Calc100DBS,'k',marker="x",linewidth=3,markersize=9)
...
plt.plot(DistDBS, Calc120DBS,'k',marker="v",linewidth=3,markersize=9)
