...
#plt.plot(Dist10TR, Poro10TR,'m-',label='Toughreact',linewidth=5)
plt.plot(Dist10TR, Poro10TR,'c-',linewidth=2.5)
...
#plt.plot(Dist100TR, Poro100TR,'m-',label='Toughreact',linewidth=5)
plt.plot(Dist100TR, Poro100TR,'c-.',linewidth=2.5)
...
#plt.plot(Dist120TR, Poro120TR,'m-',label='Toughreact',linewidth=5)
plt.plot(Dist120TR, Poro120TR,'c:',linewidth=2.5)
...
plt.plot(DistMIN, Poro10MIN,'r-',marker="o",markevery=5,markersize=6,linewidth=2.5)
...
plt.plot(DistMIN, Poro100MIN,'r-.',marker="o",markevery=5,markersize=6,linewidth=2.5)
...
plt.plot(DistMIN, Poro120MIN,'r:',marker="o",markevery=5,markersize=6,linewidth=2.5)
...
plt.plot(Dist, Poro10,'k-',marker="s",markevery=5,markersize=6,linewidth=2.5)
...
plt.plot(Dist, Poro100,'k-.',marker="s",markevery=5,markersize=6,linewidth=2.5)
...
plt.plot(Dist, Poro120,'k:',marker="s",markevery=5,markersize=6,linewidth=2.5)
...
plt.yticks(y_ticks)
plt.minorticks_on()
#plt.tick_params(axis='x',which='minor',direction='out',length=5,width=1.5)
#plt.tick_params(axis='y',which='minor',direction='out',length=5, width=1.5)
