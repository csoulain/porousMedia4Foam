...
plt.plot(DistMIN, HH120MIN,'r-v',label='MIN3P',linewidth=2.5)
...
plt.plot(Dist10TR, HH10TR,'m-*',label='Toughreact',linewidth=2.5)
...
plt.plot(Dist100TR, HH100TR,'m-x',label='Toughreact',linewidth=2.5)
...
plt.plot(Dist120TR, HH120TR,'m-v',label='Toughreact',linewidth=2.5)
...
with open('../darcyFoam/postProcessing/singleGraph/3.149928e+08/line_eps_Ys.Calcite_p.xy','r') as csvfile:
   ...
   for row in plots:
       ...
       HH10pM4F.append(float(row[3])/(1000*9.81))
plt.plot(Dist, HH10pM4F,'c-*',label='pM4F',linewidth=2.5)

HH100pM4F = []
with open('../darcyFoam/postProcessing/singleGraph/3.1499928e+09/line_eps_Ys.Calcite_p.xy','r') as csvfile:
   plots = csv.reader(csvfile, delimiter=' ')
   for row in plots:
       HH100pM4F.append(float(row[3])/(1000*9.81))
plt.plot(Dist, HH100pM4F,'c-x',label='pM4F',linewidth=2.5)

HH120pM4F = []
with open('../darcyFoam/postProcessing/singleGraph/3.78e+09/line_eps_Ys.Calcite_p.xy','r') as csvfile:
   plots = csv.reader(csvfile, delimiter=' ')
   for row in plots:
       HH120pM4F.append(float(row[3])/(1000*9.81))
plt.plot(Dist, HH120pM4F,'c-v',label='pM4F',linewidth=2.5)
...
with open('postProcessing/singleGraph/3.149928e+08/line_eps_Ys.Calcite_p.xy','r') as csvfile:
   ...
   for row in plots:
       Dist.append(float(row[0]))
       HH10.append(float(row[3])/9.81)
plt.plot(Dist, HH10,'k-*',label='dbs',linewidth=2.5)

HH100 = []
with open('postProcessing/singleGraph/3.1499928e+09/line_eps_Ys.Calcite_p.xy','r') as csvfile:
   plots = csv.reader(csvfile, delimiter=' ')
   for row in plots:
       HH100.append(float(row[3])/9.81)
plt.plot(Dist, HH100,'k-x',label='dbs',linewidth=2.5)

HH120 = []
with open('postProcessing/singleGraph/3.78e+09/line_eps_Ys.Calcite_p.xy','r') as csvfile:
   plots = csv.reader(csvfile, delimiter=' ')
   for row in plots:
       HH120.append(float(row[3])/9.81)
plt.plot(Dist, HH120,'k-v',label='dbs',linewidth=2.5)
