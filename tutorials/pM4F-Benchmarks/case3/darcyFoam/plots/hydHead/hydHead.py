...
plt.plot(DistMIN, HH10MIN,'r-*',label='MIN3P')
...
plt.plot(DistMIN, HH100MIN,'r-x',label='MIN3P')
...
plt.plot(DistMIN, HH120MIN,'r-v',label='MIN3P')
...
plt.plot(Dist10TR, HH10TR,'m-*',label='Toughreact')
...
plt.plot(Dist100TR, HH100TR,'m-x',label='Toughreact')
...
plt.plot(Dist120TR, HH120TR,'m-v',label='Toughreact')
...
plt.plot(Dist, HH10,'c-*',label='pM4F')
...
plt.plot(Dist, HH100,'c-x',label='pM4F')
...
plt.plot(Dist, HH120,'c-v',label='pM4F')
