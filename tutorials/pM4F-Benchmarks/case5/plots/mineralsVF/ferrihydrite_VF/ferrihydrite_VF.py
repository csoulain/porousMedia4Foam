...
im = image.imread('plots/mineralsVF/ferrihydrite_VF/legend.eps')
fig, ax = plt.subplots()
ax.imshow(im,aspect='auto', extent=(.65,.95,0.15,0.2), zorder=1)
...
plt.plot(Dist, Fer300,'c-v',label='pM4F')
...
plt.savefig('B3_ferVF.eps', format='eps')
plt.show()
