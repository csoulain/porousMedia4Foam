...
fig, ax = plt.subplots()
ax.imshow(im,aspect='auto', extent=(.6,.95,0.004,0.0055), zorder=1)
...
plt.plot(DistMIN, HH300MIN,'r-v',label='MIN3P',linewidth=2.5)
...
plt.plot(Dist, HH300,'c-v',label='pM4F',linewidth=2.5)
...
plt.savefig('B5_hydHead.eps', format='eps')
plt.show()
