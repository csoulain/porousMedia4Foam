...
plot "postProcessing/graphCell/5000/line.xy"  using (1-$1):2 every 15 title "t = 5000s " ps 0.75, \
     "analytical/case2/5000s"  using 1:2 with lines title "",\
     "postProcessing/graphCell/10000/line.xy" using (1-$1):2 every 15 title "t = 10000s" ps 0.75, \
     "analytical/case2/10000s" using 1:2 with lines title "",\
     "postProcessing/graphCell/15000/line.xy" using (1-$1):2 every 15 title "t = 15000s" ps 0.75, \
