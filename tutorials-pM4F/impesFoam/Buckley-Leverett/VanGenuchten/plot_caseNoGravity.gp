...
set xtics nomirror
set key at 1,0.90
plot "postProcessing/graphCell/6000/line.xy"  using (1-$1):2 every 15 title "t = 6000s " ps 0.75, \
     "analytical/case1/6000s"  using 1:2 with lines title "",\
     "postProcessing/graphCell/12000/line.xy" using (1-$1):2 every 15 title "t = 12000s" ps 0.75, \
