...
plot "postProcessing/graphCell/10000/line.xy"  using (1-$1):2 every 15 title "t = 10000s " ps 0.75, \
     "analytical/case2/10000s"  using 1:2 with lines title "",\
     "postProcessing/graphCell/20000/line.xy" using (1-$1):2 every 15 title "t = 20000s" ps 0.75, \
     "analytical/case2/20000s" using 1:2 with lines title "",\
     "postProcessing/graphCell/30000/line.xy" using (1-$1):2 every 15 title "t = 30000s" ps 0.75, \
