...
plot [0.001:1.02] 9800.19/(1000*0.5*(x**(-1.5))) ti "Analytical",\
     'postProcessing/graphCell/300000/line.xy' using 2:(-$4) every 5 ti "Numerical"
...
set key at 0.9,0.9
plot "postProcessing/graphCell/300000/line.xy" using 1:2 w l lt 3 lw 2 ti "Numerical"
