...
plt.plot(Dist10TR, Poro10TR,'m', marker="*",linewidth=3,markersize=9)
...
plt.plot(Dist100TR, Poro100TR,'m',marker="x",linewidth=3,markersize=9)
...
plt.plot(Dist120TR, Poro120TR,'m',marker="v",linewidth=3,markersize=9)

#pM4F Porosity results
Dist = []
Poro10 = []
with open('postProcessing/graphCell/3.149928e+08/line.xy','r') as csvfile:
   plots = csv.reader(csvfile, delimiter=' ')
   for row in plots:
...
Poro100 = []
with open('postProcessing/graphCell/3.1499928e+09/line.xy','r') as csvfile:
   plots = csv.reader(csvfile, delimiter=' ')
   for row in plots:
...
Poro120 = []
with open('postProcessing/graphCell/3.78e+09/line.xy','r') as csvfile:
   plots = csv.reader(csvfile, delimiter=' ')
   for row in plots:
