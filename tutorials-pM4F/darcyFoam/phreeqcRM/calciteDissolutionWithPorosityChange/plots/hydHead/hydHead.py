...
plt.plot(DistMIN, HH10MIN,'r',marker="*",linewidth=3,markersize=9)
...
plt.plot(DistMIN, HH100MIN,'r',marker="x",linewidth=3,markersize=9)
...
plt.plot(DistMIN, HH120MIN,'r',marker="v",linewidth=3,markersize=9)
...
plt.plot(Dist, HH10,'c',marker="*",linewidth=3,markersize=9)
...
plt.plot(Dist, HH100,'c',marker="x",linewidth=3,markersize=9)
...
plt.plot(Dist, HH120,'c',marker="v",linewidth=3,markersize=9)
...
##plt.plot(DistDBS, HH10DBS,'k',marker="*",linewidth=3,markersize=9)
...
##plt.plot(DistDBS, HH100DBS,'k',marker="x",linewidth=3, markersize=9)
...
##plt.plot(DistDBS, HH120DBS,'k', marker="v", linewidth=3, markersize=9)
