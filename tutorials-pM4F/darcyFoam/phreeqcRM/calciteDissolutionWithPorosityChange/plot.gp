...
plot "postProcessing/graphCell/3.149928e+08/line.xy" using 1:($4/1e4) with lines lw 5 title "10 Y", \
     "postProcessing/graphCell/3.1499928e+09/line.xy" using 1:($4/1e4) with lines lw 5 title "100 Y", \
     "postProcessing/graphCell/3.78e+09/line.xy" using 1:($4/1e4) with lines lw 5 title "120 Y", \
